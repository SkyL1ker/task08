...
# Update ACR with admin credentials enabled
...
data "azurerm_container_registry" "acr" {
  ...
  depends_on = [azurerm_container_registry.acr_admin]
}
...
module "aci" {
  ...
  depends_on = [module.acr, module.redis, data.azurerm_container_registry.acr]
}
...
# Configure kubernetes and kubectl providers after AKS is created
provider "kubectl" {
